...
const DropdownUser = ({ username, role }) => {
      ...
      {dropdownOpen && (
        ...
        >
          <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-4 dark:border-strokedark">
            <li>
              <span>
                <span className="text-light block whitespace-nowrap text-xs">
                  Xin chào Admin
                </span>
                <span className="block whitespace-nowrap text-sm font-medium text-black dark:text-white">
                  Nguyễn Văn A
                </span>
              </span>
            </li>
